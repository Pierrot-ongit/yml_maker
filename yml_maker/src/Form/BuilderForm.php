 ...
 */
class BuilderForm extends FormBase {
...
*/
  ...
  public function editBuilderTable(array $file_content, array &$form) {
    ...
    foreach ($file_content as $key => $line) {
      ...
      $form['mytable'][$key]['text'] = [
        '#type' => 'textfield',
        '#default_value' => $line['new_line'],
        '#ajax' => [
          'callback' => [$this, 'testAjax'],
          'event' => 'change',
          'progress' => [
            'type' => 'throbber',
        ...
        '#suffix' => '<span class="test-message"></span>', // TODO : Attention, à virer.
      ];

      $form['mytable'][$key]['indentSize'] = [
        '#type' => 'number',
        '#default_value' => $line['indentSize'],
        '#min' => 0,
        '#step' => 2,
        '#size' => 2,
      ];
